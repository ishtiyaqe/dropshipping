...
class AutoLinkMessage(models.Model):
    ...
    link = models.CharField(max_length=800, null=True, default='https://ecargo.com.bd/', help_text='Enter Target Page Link Here To Redirect')
    button_link = models.CharField(max_length=800, null=True, default='https://ecargo.com.bd/', help_text='Enter Target Page Link Here To Redirect. this can be diffrent from the above link.')
