...
const RequestOrdersPage = () => {
  ...
  useEffect(() => {
    ...
    clients
      ...
      .then(function (res) {
        setProgress(50);
        const initialOrders = res.data.shipping_orders;
        setOrders(initialOrders);
      ...
      <div className={`bg-white w-full ${sliderVisible ? 'duration-300' : 'hidden'}`}>
        <label className="absolute right-0 mr-10 ">
          ...
          >
            ...
            <option value="Shipping Confirm">Shipping Confirm</option>
            <option value="Shipping Shipped">Shipping Shipped</option>
            <option value="Shipping Received">Shipping Received</option>
            ...
            <option value="Shipping Closed">Shipping Closed</option>
