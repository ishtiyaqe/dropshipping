...
const OrderDetailsPopup = ({ data, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const id = data.order.shipping_id; // Assuming 'data' contains the order details
        ...
        clients.post(`Shippingpaynowreq/${id}`, formData)
            .then(function (res) {
