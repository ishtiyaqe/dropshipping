  ...
  return (
    <>
      ...
      <div className="ml-4    justify-start items-center inline-flex">
          <div className="w-20 h-5  text-base font-semibold font-['Open Sans'] leading-normal">#{order.shipping_id}</div>
        </div>
        ...
        <div className="    justify-start items-center inline-flex">
          <div className="  text-sm font-normal font-['Open Sans'] leading-tight">{order.tracking}</div>
        </div>
        <div className="      justify-start items-center inline-flex">
          <div className="  text-sm font-normal font-['Open Sans'] leading-tight">৳{order.s_total | "Not Set"}</div>
        </div>
