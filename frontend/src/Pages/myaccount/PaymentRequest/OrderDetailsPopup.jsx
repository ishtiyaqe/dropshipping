...
const OrderDetailsPopup = ({ data, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const id = data.order.payment_id; // Assuming 'data' contains the order details
        const amount = data.order.p_total; // Use the 'Due' value from your data
        ...
        formData.append('p_total', amount);
        ...
        clients.post(`PaysformePayNowReq/${id}`, formData)
            .then(function (res) {
            ...
            <div className="order-details-popup grid grid-cols-2 gap-2 h-fit  border rounded-md  shadow-md dark:shadow-gray-200 bg-white w-full p-4 text-black">
                <div className="popup-content">
                    ...
                    <div className="text-xs">
                        <strong>Order ID:</strong> {data.order.payment_id}
                    </div>
               
                    <div className="text-xs">
                        <strong>Total:</strong>৳ {data.order.p_total}
                    </div>
                </div>
