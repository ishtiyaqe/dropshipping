  ...
  return (
    <>
      ...
      <div className="ml-4    justify-start items-center inline-flex">
          <div className="w-20 h-5  text-base font-semibold font-['Open Sans'] leading-normal">#{order.OrderP_id}</div>
        </div>
        ...
        <div className="    justify-start items-center inline-flex">
          <div className="  text-sm font-normal font-['Open Sans'] leading-tight">৳{order.price.toFixed(2)}</div>
        </div>
        <div className="      justify-start items-center inline-flex">
          <div className="  text-sm font-normal font-['Open Sans'] leading-tight">৳{order.due.toFixed(2)}</div>
        </div>
